 ...
 * זהו תרשים רזוננס (resonance): שני מבנים תורמים שקולים של אותו יון, מחוברים בחץ רזוננס דו-ראשי (↔) -
...
export function AromaticityArt() {
  ...
  return (
    <MechanismArtFrame
      ...
      note="המטען השלילי על החמצן (בפנוקסיד) יכול 'להיכנס' לטבעת ולהתפזר על פחמני האורתו/פארא (עוד 2 מבני רזוננס דומים לא מצוירים כאן) - הפיזור הזה מייצב את הפנוקסיד ולכן הופך את פנול לחומצי בהרבה יותר מאלכוהול רגיל (שהאלקוקסיד שלו לא יכול להתפזר כך)."
    >
