...
export const stereochemistry: Topic = {
  ...
  subtitle: "איזומרים, קונפורמציות, כיראליות ותגובות רדיקליות",
  icon: "🪞",
  summary: [
    {
      heading: "סוגי איזומריה - המפה הכללית",
      paragraphs: [
        "איזומרים הם תרכובות בעלות אותה נוסחה מולקולרית אך מבנה שונה. החלוקה הראשונה והחשובה ביותר היא בין איזומרים קונסטיטוציוניים (מבניים) לבין סטריאואיזומרים.",
        "איזומרים קונסטיטוציוניים (Constitutional isomers) נבדלים בסדר החיבור של האטומים - כלומר איזה אטום מחובר לאיזה. לדוגמה בוטן נורמלי לעומת איזובוטן, או אלכוהול לעומת אתר עם אותה נוסחה (C₂H₆O: אתנול לעומת דימתיל אתר).",
        "סטריאואיזומרים (Stereoisomers) הם מולקולות בעלות אותה קונסטיטוציה (אותו סדר חיבור אטומים) אך סידור שונה של האטומים במרחב. כאן מתחלקים שוב לשתי תת-קטגוריות מהותיות: קונפורמציה וקונפיגורציה.",
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "תרכובת מזו היא דיאסטראומר (לא אננטיומר!) של זוג האננטיומרים הכיראליים בעלי אותה קונסטיטוציה - כלומר עבור מולקולה עם שני מרכזים סטריאוגניים זהים (כמו חומצה טרטרית), קיימים שלושה סטריאואיזומרים בסך הכול: זוג אננטיומרים כיראלי (R,R) ו-(S,S), ותרכובת המזו (R,S) שהיא אכיראלית ומהווה דיאסטראומר של שניהם.",
    ...
    {
      heading: "תגובות רדיקליות: הלוגנציה רדיקלית של אלקאנים",
      paragraphs: [
    ...
    },
    {
      ...
      bullets: [
        "רגיוסלקטיביות (Regioselectivity) - תגובה שיוצרת יותר מאיזומר קונסטיטוציוני אחד מאשר מאחר (למשל כלל מרקובניקוב בהוספת HX לאלקן).",
  ...
  comparisonTables: [
    {
      ...
      rows: [
        ["איזומרים קונסטיטוציוניים", "נוסחה מולקולרית", "סדר חיבור האטומים", "בוטן לעומת איזובוטן"],
        ["קונפורמרים", "קונסטיטוציה, קונפיגורציה", "זווית סיבוב סביב קשר σ בלבד", "anti-בוטאן לעומת gauche-בוטאן"],
        ["אננטיומרים", "קונסטיטוציה, תכונות פיזיקליות", "תמונת ראי לא ניתנת להלבשה", "(R)-2-בוטנול לעומת (S)-2-בוטנול"],
        ["דיאסטראומרים", "קונסטיטוציה בלבד", "קונפיגורציה של חלק (לא כל) המרכזים הסטריאוגניים", "(2R,3R) לעומת (2R,3S) של חומצה טרטרית"],
      ],
    },
    {
  ...
  B -->|"לא"| C["איזומרים קונסטיטוציוניים (מבניים)"]
  ...
  J -->|"לא"| L["זוג אננטיומרים כיראלי אמיתי"]`,
      note: "המפה השלמה: קודם קונסטיטוציה מול סטריאואיזומריה, ואז קונפורמציה מול קונפיגורציה, ולבסוף אננטיומרים/דיאסטראומרים/מזו.",
    },
    {
  ...
  molecules: [
    ...
    },
    {
      ...
      caption: "איזומר קונסטיטוציוני של בוטאן - אותה נוסחה מולקולרית (C₄H₁₀), סדר חיבור אטומים שונה לגמרי.",
    },
    {
      name: "2-מתילבוטאן",
      formula: "(CH₃)₂CHCH₂CH₃",
    ...
    },
    {
      ...
      caption: "תת-מצע שלישוני - הרדיקל/קרבוקטיון השלישוני הנוצר ממנו הוא היציב ביותר מבין 3°/2°/1°/מתילי.",
    },
  ],
  quiz: [
    {
