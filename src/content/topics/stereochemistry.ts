...
export const stereochemistry: Topic = {
  ...
  summary: [
    {
      ...
      paragraphs: [
        ...
        "איזומרים מבניים (Constitutional isomers) נבדלים בסדר החיבור של האטומים - כלומר איזה אטום מחובר לאיזה. לדוגמה בוטן נורמלי לעומת איזובוטן, או אלכוהול לעומת אתר עם אותה נוסחה ([[chem:C2H6O]]: אתנול לעומת דימתיל אתר).",
  ...
  molecules: [
    ...
    },
    {
      ...
      caption: "איזומר מבני של בוטאן - אותה נוסחה מולקולרית ([[chem:C4H10]]), סדר חיבור אטומים שונה לגמרי.",
    },
    {
      name: "2-מתילבוטאן",
      formula: "(CH₃)₂CHCH₂CH₃",
